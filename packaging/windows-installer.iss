...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\setup.ps1"""; WorkingDir: "{app}"; Description: "Start sayIt and enable launch at sign-in"; Flags: postinstall skipifsilent waituntilterminated
